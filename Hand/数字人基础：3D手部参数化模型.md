...
![](images/v2-620155e3d60094ec5bdb82c0ab3d8ca6_720w.webp)
...
![](images/v2-f8e6e9cb84c7231725c137d6df3f0565_720w.webp)
...
![](images/v2-c7181d6339bc46299069c270e4068dce_720w.webp.png)
...
![](images/v2-85c4fdfa67908961c963f75fd7a25714_720w.webp)
...
![](images/v2-fea54088ac245d53cc2803900253e4ac_720w.webp)

MANO所用的数据采集系统

![](images/v2-7399a8a3818eec4a6762c4fe177dc964_720w.webp)
...
![](images/v2-365c5ea62013041df6d67ebddcfe5a57_720w.webp)

示意图来自DART(NeurIPS 2022), 原始的MANO模型只有粉色部分, 即MANO模型不包含手腕部分。

---

![](images/v2-a31d3d0dcbb9ecbb67881ef0044ece5e_720w.webp.png)
...
![](images/v2-bf82e49f09cb3d9bfebc7d936a72e508_720w.webp)
...
![](images/v2-20dc5f440a7abd40c2a9352949362608_720w.webp)

HTML纹理基的示意图

虽然从创新性上来说，HTML是非常不错的，但是其恢复出来的纹理质量还是和真实的数据不够贴近：包括没有真实感的**掌纹，指甲，汗毛**等等。

![](images/v2-4c518e1c57598fe0f92cb61d92a3749f_720w.webp)
...
![](images/v2-d7cbdaa188b4c1aeb8301c10990c9f9b_720w.webp)

NIMBLE示意图：包含肌肉，骨骼和高质量的纹理

此论文开创性的使用MRI数据来构建骨骼和肌肉，其纹理也是由Appearance model来控制, 渲染质量非常高。

![](images/v2-9c878e65905bf185b91411fa3eb2e02b_720w.webp)
...
![](images/v2-32582ba4bf2df3222acf074cc56c0615_720w.webp)
...
![](images/v2-1e903ad0f6f3927e58f1b3563b7211a5_720w.webp)

DART的300+高质量纹理贴图

![](images/v2-28c7ec868d083b088664a242489a4b0f_720w.webp)

通过对贴图的随机offset，可以模拟各种各样的肤色

由于饰品的存在，DART基于MANO做了一个手腕部分的扩展，从而能够模拟手表手链戴在手上的效果：

![](images/v2-98542333a01551b7cc37686b748b4fb4_720w.webp)
...
![](images/v2-ca7a6e332da91a17f8c978f5be7a4e0d_720w.webp)
...
![](images/v2-195d1247d8f09befb57fddb9ef93072a_720w.webp)
...
![](images/v2-37dcd87d5fd880d2cdc8931771f3f043_720w.webp)

HandAvatar概览图

熟悉的作者合影环节，左边是来自西班牙 [IRI-UPC](https://link.zhihu.com/?target=http%3A//www.iri.upc.edu/)的Enric Corona, 右边是在小冰当研究员的Xingyu Chen。

![](images/v2-d738474fcc2fc1f457181f259d1c1e8a_720w.webp)

左: Enric Corona, 右: Xingyu Chen

---

![](images/v2-a5667254ac655b53111588727640d5ca_720w.webp)
